// Equivalent to src/routes/ctgrassroots/explination.ts
...
export const exp = [
  {
    ...
    explanation: `The CTGrassRoots website is an instance of mobilizon,
        ...
        Click <a href="https://ctgrassroots.org/">here</a> to access CTGrassRoots and use this website.`,
  },
  {
    ...
    explanation: `Mobilizon is a web application that can be copied and recreated
        by anyone who has the source code. The developers actually emphasis trying to
        make your own instances for it helps to disperse the power of just a singular instance.
        These separate instances can still communicate with each other, creating a
        connected web allowing all these different instances to feel as if it's
        one large website.`,
  },
  {
    header:
      "If Mobilizon's code is already built by other people then what work went into building CTGrassRoots?",
    explanation: `Although the web application code is a key component to having a functional websit
        it's not the only one. I like to think of it as building a car, if the web application
        ...
        , built together, then when done constantly maintained to ensure the car
  ...
  },
  {
    ...
    explanation: `Although Mobilizon and the work I am doing to host this website follows the
        ...
        patreon <a href="https://www.patreon.com/SystemSimulacrum">here</a>.`,
  },
  {
  ...
  },
  {
    ...
    explanation: `The main goal of CTGrassRoots is to help facilitate the growth of local organization where ever
  ...
  },
  {
    ...
    explanation: `There is plenty of ways to help CTGrassRoots them being:
        <ul>
            ...
            <li> Report any malicious behavior and be kind. </li>
        ...
        If you want to learn more about computer science, it's effect on community stability, and the
