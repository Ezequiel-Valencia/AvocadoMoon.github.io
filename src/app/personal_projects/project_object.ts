// Equivalent to src/routes/personal_projects/project_object.ts
...
export const projects: { [key: string]: Projects[] } = {
  'Projects Involving Frontend, BackEnd or Both': [
    {
      ...
      technologies: [
        ...
        csWorkTechnologies.TypeScript,
        csWorkTechnologies.Svelte,
        csWorkTechnologies.SQL,
        csWorkTechnologies.Go,
  ...
  'Application Management, Security, Observability, and Network Control.': [
    {
      ...
      description: `I've repurposed old computers and built new ones to create a data center with Proxmox as the unifying type 1 hypervisor, placed within a separate VLAN.
            ...
            `,
      technologies: [
        csWorkTechnologies.Proxmox,
        csWorkTechnologies.Ansible,
        csWorkTechnologies.Docker,
        csWorkTechnologies.Consul,
        csWorkTechnologies.Grafana,
        csWorkTechnologies.Istio,
        csWorkTechnologies.K8,
        csWorkTechnologies.Loki,
        csWorkTechnologies.Prometheus,
        csWorkTechnologies.TrueNas,
        csWorkTechnologies.Ubiquity,
  ...
  'All the software projects that don\'t neatly fit into a category.': [
    ...
    },
    {
      ...
      technologies: [
        csWorkTechnologies.Python,
        csWorkTechnologies.GoogleScholar,
        csWorkTechnologies.LaTeX,
      ],
    },
    {
      name: 'Secret Santa',
