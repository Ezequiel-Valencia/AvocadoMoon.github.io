  ...
  <div class="education-content">
    <article class="education-article">
      <div>
        ...
        <h5>GPA: 3.77</h5>
        <p style="margin: 4%;">
          Getting my education in Cybersecurity was one of the best decisions I've made. The subject
          requires a grasp on all CS subjects for setting a secure enterprise system. That is
          network, OS, hardware, front-end, back-end, and CI/CD security. With this knowledge I can
          both excel in personal projects and in the work field.
        </p>
      </div>
    ...
    <article class="education-article">
      ...
      <div>
        ...
        <p style="margin: 4%;">
          My degree is simply a preamble to all the learning it'll continue to do for the rest of my
          life. Constantly self-teaching by finding projects to act as vehicles to drive my
          motivation through rough patches of complicated technologies.
        </p>
        <div style="display: flex; height:auto; flex-wrap:wrap;">
          {#each technology_learned as icon, index (index)}
                ...
                <div id={'description-' + index} class="tech description-holder">
                  <div class="description">
                    ...
                    <ul style="text-align: left; font-family:'Times New Roman', Times, serif">
                      {#each icon.projects as project, i (i)}
                        <li>{project}</li>
                      {/each}
                    </ul>
                  </div>
...
<style lang="scss">
  ...
  .black-over-top {
    ...
    mask-image: radial-gradient(
      ...
      rgba(255, 255, 255, 0) 2vmax,
      rgb(255, 255, 255) 40vmax
    );
  }
