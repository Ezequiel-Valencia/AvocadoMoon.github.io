<script lang="ts">
  ...
  import { GeoCacheApi, ResponseError, type GeoCacheSubmission } from '../../backend-api';
  ...
  async function handleGuestSubmission(e: SubmitEvent) {
    ...
    let submission: GeoCacheSubmission = {
      name: username,
      note: note,
      secret: secret,
      longitude: longitude,
    ...
    <form onsubmit={handleGuestSubmission}>
      <label>
        ...
        <textarea
          ...
          style="border-radius: 6px; width:30vw;"
          name="note"
          id="note"></textarea>
        <br />
        <br />
          ...
          {:else}
            <div style="width: 30vw; text-align:center; margin:auto; display:inline;">
              ...
              <div style="width:30vw; display:inline-block;">
                <input
                  required
                  defaultValue={latitude == undefined ? '' : latitude}
                ...
                <input
                  required
                  defaultValue={longitude == undefined ? '' : longitude}
        ...
        <div style="width: 30vw; text-align:center; margin:auto;" class="flex items-center">
          <button
            ...
            onclick={() => {
              addSecret = !addSecret;
            }}>{addSecret ? 'Remove' : 'Add'} Secret?</button
          >
          <button
            ...
            }}>{addLocation ? 'Remove' : 'Add'} Location?</button
          >
